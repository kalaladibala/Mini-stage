...
<p style="text-align:left;font-size:14px;"> Entre l'établissement d'accueil : <br><b><?php echo $Conv['type'] ?>  <?php echo $Conv['nometab'] ?><br><?php echo $Conv['adresse'] ?> - <?php echo $Conv['cp'] ?> <?php echo $Conv['ville'] ?><br>Tél. : <?php echo $Conv['tel'] ?><br>Email :<span  style="color:#1E00FF;font-weight: bold;" > <?php echo $Conv['mail'] ?></span></b></p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Professeur encadrant : <b><?php echo $Conv['nom_prof'] ?></b>  
</p>
