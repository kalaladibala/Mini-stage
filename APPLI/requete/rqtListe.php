...
function get_ListeReserv(){
	...
	e.nometab, tf.nomcourt_typeformation as typeformation, f.nom_formation as formation, 	fo.nom_fonct as fonction,
	date as dateUS,  DATE_FORMAT(date, "%d-%m-%Y") AS dateFR, hdebut, hfin, confirmation, rappel, absence, c.nom_compte as nomO, c.prenom_compte as prenomO, fo.nom_fonct as fonction
...
inner join t_compte as c on c.idcompte=r.idReservant
inner join t_etablissement as e on e.idetab=c.idetab
...
/*function get_ListeReservLycee(){
    ...
    $rqt = 'SELECT r.idreserv as id, r.nom as nom, r.prenom, u.mailetab, u.mail, u.ville, u.tel, t.nom as typel, t.nomcourt as type, u.nometab, 
	...
	inner join t_compte as u on r.idReservant=u.id
...
inner join t_ministage as m on m.idministage=r.idministage
	...
	inner join t_typeetab as t on t.idtypeetab=e.idtypeetab
	inner join t_fonction as fo on c.idfonction=fo.idfonction
	where r.idReservant = '.$_SESSION['IdUtilisateur'].' AND date<DATE(NOW())
	ORDER BY date;';
